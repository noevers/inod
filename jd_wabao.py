...
class Msg(object):
    def getsendNotify(self):
        url_list = [
            'https://mirror.ghproxy.com/https://raw.githubusercontent.com/noevers/inod/master/sendNotify.py',
            'https://raw.fastgit.org/noevers/inod/master/sendNotify.py',
            'https://raw.githubusercontent.com/noevers/inod/master/sendNotify.py',
        ]
