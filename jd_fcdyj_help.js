...
[task_local]
#发财大赢家
0 12 * * * https://raw.githubusercontent.com/KingRan/JDJB/main/jd_fcdyj.js, tag=发财大赢家, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "0 12 * * *" script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_fcdyj.js tag=发财大赢家

===============Surge=================
发财大赢家 = type=cron,cronexp="0 12 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_fcdyj.js

============小火箭=========
发财大赢家 = type=cron,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_fcdyj.js, cronexpr="0 12 * * *", timeout=3600, enable=true
 */
const $ = new Env('发财大赢家');
...
!(async () => {
    ...
    console.log('环境变量添加示例：环境变量：export dyjCode="cab8da78fc144424b1f2eee0531a4e3f202516320672006@aN8mFXv3ct4DWk6uKZew"')
