        ...
        $.post(options, async (err, resp, data) => {
            try {
                    ...
                    if(data.errMsg == "success"){
                      ...
                      $.log(`\n===================================`)
                      $.log(`🐶旺财等级:${dj}\n🐶购买旺财等级:${gmdj}\n🐶当前金币:${jb}\n===================================\n`)
					  console.log(`\n【京东账号${$.index}（${$.UserName}）的${$.name}好友互助码】${yqm}\n`);
...
function openinvite(code) {
		...
		body: `functionId=joyBaseInfo&body={"taskId":"","inviteType":"2","inviterPin":"${code}","linkId":"LsQNxL7iWDlXUs6cFl-AAg"}&_t=1625540360946&appid=activities_platform`,
		headers: {
		"Origin": "https://joypark.jd.com",
		"Host": "api.m.jd.com",
		"User-Agent": "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/48.0.2564.116 UBrowser/5.6.12150.8 Safari/537.36",
...
function inviteType() {
    ...
    body: `functionId=joyBaseInfo&body={"taskId":"167","inviteType":"1","inviterPin":"${code}","linkId":"LsQNxL7iWDlXUs6cFl-AAg"}&_t=1625540360946&appid=activities_platform`,
	headers: {
	"Origin": "https://joypark.jd.com",
	"Host": "api.m.jd.com",
	"User-Agent": "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/48.0.2564.116 UBrowser/5.6.12150.8 Safari/537.36",
...
function apTaskinviter() {
    ...
    body: `functionId=joyBaseInfo&body={"taskId":"167","inviteType":"1","inviterPin":"${code}","linkId":"LsQNxL7iWDlXUs6cFl-AAg"}&_t=1625543629130&appid=activities_platform`,
	headers: {
	"Origin": "https://joypark.jd.com",
	"Host": "api.m.jd.com",
	"User-Agent": "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/48.0.2564.116 UBrowser/5.6.12150.8 Safari/537.36",
